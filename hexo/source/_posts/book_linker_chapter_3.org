...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--linker_load/section_struct.jpg?raw=true" alt="section_struct.jpg">
...
由此可以得到文件全局视图:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--linker_load/elf_file.jpg?raw=true" alt="elf_file.jpg">- 文件的大小正好完全吻合
...
#+END_SRC
#+BEGIN_EXAMPLE
  cec@virtual:~/learn/c/hello$ ./special_symbol
  executable start 0x400000
  text end 0x40061d 0x40061d 0x40061d
  data end 0x601038 0x601038
  executable end 0x601040 0x601040
#+END_EXAMPLE
** 符号修饰与函数签名
