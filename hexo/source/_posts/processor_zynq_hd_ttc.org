...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/ttc/ttc_block_diagram.jpg?raw=true" alt="ttc_block_diagram.jpg">
** 分配与计数
- 分频器的值可设范围为 2 ~ 65536
- 计数器可以配置向上计数或向下计数
** 操作模式
