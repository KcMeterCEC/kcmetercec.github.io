...
* 对硬件的要求
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--ostep/virtualization/mem_translation_hd_requirement.jpg?raw=true" alt="mem_translation_hd_requirement.jpg">
...
* 对操作系统的要求
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--ostep/virtualization/mem_translation_sw_requirement.jpg?raw=true" alt="mem_translation_sw_requirement.jpg">
操作系统对应的也需要做如下支持：
...
结合软件和硬件的配合流程如下图：
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--ostep/virtualization/mem_translation_process1.jpg?raw=true" alt="mem_translation_process1.jpg">
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--ostep/virtualization/mem_translation_process2.jpg?raw=true" alt="mem_translation_process2.jpg">
