...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--图解TCPIP/chapter3/preamble.jpg?raw=true" alt="preamble.jpg">
如上图所示，前7字节都是 10101010，最后一字节的低两位是"11"，IEEE802.3将其称为起始域SFD，以代表接下来是帧本体。
*** 帧本体
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--图解TCPIP/chapter3/eth_frame.jpg?raw=true" alt="eth_frame.jpg">
...
IEEE802.3中帧格式有些不同:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--图解TCPIP/chapter3/ieee_frame.jpg?raw=true" alt="ieee_frame.jpg">
- 其中SNAP用于标识上一层的协议类型。
...
** 帧格式
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--图解TCPIP/chapter3/ppp_frame.jpg?raw=true" alt="ppp_frame.jpg">
