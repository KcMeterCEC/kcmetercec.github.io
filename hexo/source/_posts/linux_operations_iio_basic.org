...
* 结构
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[operations]/[What]Linux--IIO/libiio_struct.jpg?raw=true" alt="libiio_struct.jpg">
由上图可以看出:
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[operations]/[What]Linux--IIO/api_struct.jpg?raw=true" alt="api_struct.jpg">
API由以下4部分组成:
