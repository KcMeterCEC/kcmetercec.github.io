...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--ostep/virtualization/cfs_time_slice.jpg?raw=true" alt="cfs_time_slice.jpg">- 当前任务的 =weight= 除以总运行任务的 =weight= 的和，再乘以 =sched_latency= 
#+BEGIN_EXAMPLE
  比如当前系统有任务 A 和 B：
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--ostep/virtualization/cfs_vruntime.jpg?raw=true" alt="cfs_vruntime.jpg">- 可以看到：当 nice 值越高， weight 越大，其 =vruntime= 增加得就越慢，那么它占用 CPU 的资源就越多。
