...
1. 数据在一个进程内在用户空间交互
2. 数据经过了内核pipe进行交互
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[operations]/[What]Linux--program/process_communication/pipe_two_ways.jpg?raw=true" alt="pipe_two_ways.jpg">
在实际使用中，用得最多的是父子进程间的通信
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[operations]/[What]Linux--program/process_communication/pipe_fork.jpg?raw=true" alt="pipe_fork.jpg">- 当写端的被关闭时，读端读取时将会返回0.
