...
```
效果如下：
![](https://github.com/KcMeterCEC/explore/blob/master/[Qt]/[Quick]/QML/pic/rectangle.jpg?raw=true)
## Text
...
```
效果如下：
![](https://github.com/KcMeterCEC/explore/blob/master/[Qt]/[Quick]/QML/pic/text.jpg?raw=true)
## Image
...
```
效果如下：
![](https://github.com/KcMeterCEC/explore/blob/master/[Qt]/[Quick]/QML/pic/image.jpg?raw=true)
...
显示效果如下：
![](https://github.com/KcMeterCEC/explore/blob/master/[Qt]/[Quick]/QML/pic/pos_column.jpg?raw=true)
...
```
![](https://github.com/KcMeterCEC/explore/blob/master/[Qt]/[Quick]/QML/pic/pos_row.jpg?raw=true)
...
![](https://github.com/KcMeterCEC/explore/blob/master/[Qt]/[Quick]/QML/pic/pos_grid.jpg?raw=true)
# 布局
...
实际效果：
![](https://github.com/KcMeterCEC/explore/blob/master/[Qt]/[Quick]/QML/pic/layout.jpg?raw=true)
#  输入
## `TextInput`
...
![](https://github.com/KcMeterCEC/explore/blob/master/[Qt]/[Quick]/QML/pic/textInput.jpg?raw=true)
