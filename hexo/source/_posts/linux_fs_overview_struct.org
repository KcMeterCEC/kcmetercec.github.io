...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_basic/vfs_overview.jpg?raw=true" alt="vfs_overview.jpg">
- 在驱动中，无论是字符设备、块设备、还是其他文件系统，与VFS所接口的都是填充 =struct file_operations= 结构体
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_basic/vfs_fileoperations.jpg?raw=true" alt="vfs_fileoperations.jpg">
一个ext文件系统的组成部分如下图：
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_basic/fs_struct_overview.jpg?raw=true" alt="fs_struct_overview.jpg">
*** Boot Sector 
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_basic/inode_block_overview.jpg?raw=true" alt="inode_block_overview.jpg">
一个inode的大小是有限制的，如果一个文件很大，就会需要很多的block。
那么一个inode就无法存储这么多地址，所以文件系统使用一部分block来存储inode，如下图：
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_basic/inode_save_block.jpg?raw=true" alt="inode_save_block.jpg">
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_basic/dir2file.jpg?raw=true" alt="dir2file.jpg">
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_basic/soft_link_overview.jpg?raw=true" alt="soft_link_overview.jpg">
软链接优点：
1. 可以跨文件系统
2. 可以链接目录
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_basic/hard_link_overview.jpg?raw=true" alt="hard_link_overview.jpg">
硬链接的优点：
...
嵌入式批量出厂时， 可以在 =sed= 的帮助下完成自动化的分割，来源于 [[https://superuser.com/questions/332252/how-to-create-and-format-a-partition-using-a-bash-script][StackExchange]]
#+begin_example
