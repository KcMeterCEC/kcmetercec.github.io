...
** 概览
zynq的整体启动流程如下图:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/boot/boot.jpg?raw=true" alt="boot.jpg">
...
** PL的配置路径
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/boot/pl_conf_path.jpg?raw=true" alt="pl_conf_path.jpg">
如上图所示PL有3种配置路径：
1. JTAG连接TAP控制器
  - 用于非安全模式
  - 需要PL被配置于TAP接口
...
3. ICAP控制
  ...
  - 需要PL已经被事先下载了bit流
** 设备配置接口
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/boot/devc_struct.jpg?raw=true" alt="devc_struct.jpg">
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/boot/power_requirements.jpg?raw=true" alt="power_requirements.jpg">
** 时钟
...
** 启动模式管脚
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/boot/boot_mode.jpg?raw=true" alt="boot_mode.jpg">
...
* bootrom
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/boot/bootrom_flow.jpg?raw=true" alt="bootrom_flow.jpg">
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/boot/bootrom_header1.jpg?raw=true" alt="bootrom_header1.jpg">
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--hardware/boot/bootrom_header2.jpg?raw=true" alt="bootrom_header2.jpg">
