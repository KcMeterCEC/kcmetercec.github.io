...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/xor.jpg?raw=true" alt="xor.jpg">
** 用逻辑门实现1+1=2
将等式 “1+1=2” 转换为2进制等式:
- 0 + 0 = 0
- 1 + 0 = 1
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/half_adder.jpg?raw=true" alt="half_adder.jpg">
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/adder.jpg?raw=true" alt="adder.jpg">
- 两个半加器的进位通过或门输出，其逻辑是两个半加器最多有一个会产生进位。

而多位的二进制运算便是串联形式的处理上一级产生的进位:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/4bits_adder.jpg?raw=true" alt="4bits_adder.jpg">
...
比如有如下原始逻辑:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/bool_normal.jpg?raw=true" alt="bool_normal.jpg">
如果直接按照此逻辑生成逻辑图如下:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/bool_normal_circuit.jpg?raw=true" alt="bool_normal_circuit.jpg">
- 可以看到运算逻辑需要8级传递才能得出最终值，比较耗费时间。

经过公式化简后:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/bool_simple.jpg?raw=true" alt="bool_simple.jpg">
对应的逻辑图为:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/bool_simple_circuit.jpg?raw=true" alt="bool_simple_circuit.jpg">
- 化简以后的电路只需要5级传递就可得出最终值。
* 让电路具有记忆功能
** D触发器
前面的加法器假设是人通过按键来触发输入，为了不一直按着按键以保持状态。那么除了使用自锁按键，还可以使用记忆组合电路。

#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/D_ff.jpg?raw=true" alt="D_ff.jpg">
上图既是一个D触发器（锁存器）的内部组成逻辑：
- 当L为1时，Q与D的值一致
- 当L为0时，Q保持L为0前的值
** 边沿触发器
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/edge_trigger.jpg?raw=true" alt="edge_trigger.jpg">
...
- 也就是对时钟源有振荡频率的限制。  
** 多分频器
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/clock.jpg?raw=true" alt="clock.jpg">
如果将一个半频器的输出与下一个半频器的锁存连接，变就形成了4分频器。
以此推类，每增加一个半频器，输出频率除以2.
* 计数器

#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--大话计算机/chapter1/counter.jpg?raw=true" alt="counter.jpg">
