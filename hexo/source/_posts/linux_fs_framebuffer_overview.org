...
** 硬件连接
通常的显示硬件连接如下图：
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[driver]/[What]Linux--frameBuffer/display_hd.jpg?raw=true" alt="display_hd.jpg">soc内部显示缓存的数据经由DMA送至时序发生器,时序发生器将输入的数据流以一定的时序送给LCD接口便可显示.
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[driver]/[What]Linux--frameBuffer/fb_struct.jpg?raw=true" alt="fb_struct.jpg">
** 数据结构
