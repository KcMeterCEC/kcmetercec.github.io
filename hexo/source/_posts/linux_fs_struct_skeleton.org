...
<!--more-->
#+END_EXPORT
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--skeleton/vfs_fileoperations.jpg?raw=true" alt="vfs_fileoperations.jpg">
* 访问硬盘整体视野
由上图可以看出，虚拟文件系统抽象了各种文件系统的操作为一个 =struct file_operations= 结构体中，至于这个 =file_operations= 如何访问到硬盘呢？
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--skeleton/vfs_harddisk.jpg?raw=true" alt="vfs_harddisk.jpg">
具体流程如上图所示：
** 由进程到inode
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--skeleton/direct_sync.jpg?raw=true" alt="direct_sync.jpg">- 普通方式下，数据读写都是暂存在cache中的
...
如下图所示：
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--skeleton/io_hd.jpg?raw=true" alt="io_hd.jpg">
