...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_struct/vfs_fileoperations.jpg?raw=true" alt="vfs_fileoperations.jpg">
#+BEGIN_EXPORT html
<!--more-->
#+END_EXPORT
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_struct/simplefs_struct.jpg?raw=true" alt="simplefs_struct.jpg">
可以看出此文件系统的确是足够的简单：
1. superblock描述极为简单
...
其数据填充结果如下图：
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_struct/struct_super_block.jpg?raw=true" alt="struct_super_block.jpg">
...
* FUSE
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[fs]/[What]Linux--fs_struct/fuse.jpg?raw=true" alt="fuse.jpg">
