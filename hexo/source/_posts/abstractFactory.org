...
按照 UML 类图的简易逻辑如下：
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[language]/[What]c_cpp--base/gof/pic/abstractFactory.jpg?raw=true" alt="pic/abstractFactory.jpg">
如上图所示：
