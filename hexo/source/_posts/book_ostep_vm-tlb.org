...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--ostep/virtualization/mempic/tlb/tlb_ex.jpg?raw=true" alt="mempic/tlb/tlb_ex.jpg">
下面假设访问这个数组的代码如下：
#+BEGIN_SRC c
  int sum = 0;
  for(i = 0; i < 10; i++)
...
* 真实的 TLB 项
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--ostep/virtualization/mempic/tlb/tlb_entry.jpg?raw=true" alt="mempic/tlb/tlb_entry.jpg">
