...
* OpenEmbedded 工作流
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[make]/[What]Linux--yocto/OpenEmbedded_workflow.jpg?raw=true" alt="OpenEmbedded_workflow.jpg">
** metadata files
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[make]/[What]Linux--yocto/OpenEmbedded_arch.jpg?raw=true" alt="OpenEmbedded_arch.jpg">
#+BEGIN_EXAMPLE
...
一个典型的元数据层级关系如下图:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[make]/[What]Linux--yocto/layer_arch.jpg?raw=true" alt="layer_arch.jpg">
每个层都有大致相同的结构：
