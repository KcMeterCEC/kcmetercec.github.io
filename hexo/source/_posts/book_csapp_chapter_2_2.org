...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--CS_APP/chapter2/b2uw_equation.jpg?raw=true" alt="b2uw_equation.jpg">
- w 代表整数一共有w位
- x_{i} 分别代表每一位的索引
- 可表示的范围为 0 ～ 2^{w} - 1
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--CS_APP/chapter2/b2tw_equation.jpg?raw=true" alt="b2tw_equation.jpg">
