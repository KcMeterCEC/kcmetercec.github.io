...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[arm]/[assembly]/instruction_format.jpg?raw=true" alt="instruction_format.jpg">
如下所示:
#+BEGIN_SRC asm
    @ // r2= max(r0, r1):
    @ r2= r0>=r1 ? r0 : r1;
...
** 数据操作指令
数据操作指令如下表所示:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[arm]/[assembly]/data_operation.jpg?raw=true" alt="data_operation.jpg">上面这个表格中关于乘法指令需要注意的是: 
