...
* 图的概念
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[program]/[What]program--datastruct/graph/graph.jpg?raw=true" alt="graph.jpg">
* 图的存储
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[program]/[What]program--datastruct/graph/adj_save.jpg?raw=true" alt="adj_save.jpg">
优点:
1. 基础数组存储，其操作效率高
2. 方便使用矩阵运算来计算图
缺点:
...
使用数组和链表存储指向关系:
- 数组存放顶点，链表表示每个顶点的关系
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[program]/[What]program--datastruct/graph/list_save.jpg?raw=true" alt="list_save.jpg">
优点:
1. 节省存储空间
缺点：
1. 查找效率没有邻接矩阵高
...
** 实践
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[program]/[What]program--datastruct/graph/bfs.jpg?raw=true" alt="bfs.jpg">
