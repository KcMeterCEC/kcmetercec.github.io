...
ARP包格式如下:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[goodBook]/[What]goodBook--图解TCPIP/chapter5/arp_protocol.jpg?raw=true" alt="arp_protocol.jpg">** RARP(Reverse Address Resolution Protocol)
