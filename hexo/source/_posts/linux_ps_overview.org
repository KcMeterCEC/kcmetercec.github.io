...
** 进程的状态
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[PS]/[What]ps--basic/linux_process_life_cycle.jpg?raw=true" alt="linux_process_life_cycle.jpg">
*注意：* 
...
- 此父进程有可能是init进程，也可能是具有subreaper属性的进程。
  + 这要根据子进程是否挂接在各自的链表中
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[Linux]/[PS]/[What]ps--basic/orphan.jpg?raw=true" alt="orphan.jpg">*** subreaper
