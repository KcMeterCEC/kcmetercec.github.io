...
* bootrom
boortom载入fsbl的流程如下图:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--petalinux/boot/bootrom2fsbl.jpg?raw=true" alt="bootrom2fsbl.jpg">* fsbl
fsbl流程如下图所示:
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--petalinux/boot/fsbl_flow.jpg?raw=true" alt="fsbl_flow.jpg">
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--petalinux/boot/boot_img.jpg?raw=true" alt="boot_img.jpg">
** image header table
...
#+HTML:<img src="https://github.com/KcMeterCEC/explore/blob/master/[processor]/[Zynq]/[What]Zynq--petalinux/boot/bif_example.jpg?raw=true" alt="bif_example.jpg">
*** 属性
具有两种属性类型：
